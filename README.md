...
- Adjustable position, size, spacing, node style, fill color, end-decoration style, and fade behavior.
...
- Open **Skyriding Vigor** to enable the restored vigor display and adjust its position, size, spacing, node style, fill color, end decorations, and fade behavior.
