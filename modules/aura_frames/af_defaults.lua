...
M.defaults = {
    ...
    move_combined       = false,
    timer_combined      = true,
    timer_swipe_combined = true,
    tooltip_combined    = true,
    bg_combined         = false,
    scale_combined      = 1.0,
    spacing_combined    = 2.0,
    width_combined      = M.DEFAULT_FRAME_WIDTH,
    bar_mode_combined   = true,
    color_combined      = shared_bar_color_default("buff"),
    bar_bg_color_combined = default_bg_color(),
    fade_ooc_combined = false,
    ooc_alpha_combined = addon.DEFAULT_FADE_ALPHA,
    ...
    test_aura_combined = false,
    bar_text_color_combined = { r = 1, g = 1, b = 1 },
    ...
    positions = {
        ...
        combined = { point = "TOPLEFT", x = 100, y = 29 },
