...
CampaignQuestObjectiveTracker.ContentsFrame = CreateFrame("Frame", nil, CampaignQuestObjectiveTracker)
CampaignQuestObjectiveTracker.Header = CreateFrame("Frame", nil, CampaignQuestObjectiveTracker)
CampaignQuestObjectiveTracker.Header.MinimizeButton = CreateFrame("Button", nil, CampaignQuestObjectiveTracker.Header)
QuestObjectiveTracker = CreateFrame("Frame", "QuestObjectiveTracker", ObjectiveTrackerFrame)
QuestObjectiveTracker.ContentsFrame = CreateFrame("Frame", nil, QuestObjectiveTracker)
QuestObjectiveTracker.Header = CreateFrame("Frame", nil, QuestObjectiveTracker)
QuestObjectiveTracker.Header.MinimizeButton = CreateFrame("Button", nil, QuestObjectiveTracker.Header)
AchievementObjectiveTracker = CreateFrame("Frame", "AchievementObjectiveTracker", ObjectiveTrackerFrame)
AchievementObjectiveTracker.ContentsFrame = CreateFrame("Frame", nil, AchievementObjectiveTracker)
AchievementObjectiveTracker.Header = CreateFrame("Frame", nil, AchievementObjectiveTracker)
AchievementObjectiveTracker.Header.MinimizeButton = CreateFrame("Button", nil, AchievementObjectiveTracker.Header)
