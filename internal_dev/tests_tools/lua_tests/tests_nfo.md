...
- `tests/test_ob_auto_collapse.lua`: Objectives native section Auto-Collapse, manual-open persistence, combat deferral, module-disable restoration, and the prohibition on collapsing the parent tracker.
