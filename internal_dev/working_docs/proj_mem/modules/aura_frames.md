...
- Focused Aura profile history and generated comparisons live in `cpu_profiles/af_cpu_profiles.md`; regenerate the normalized comparison with `analyze_af_cpu_profiles.ps1`.
