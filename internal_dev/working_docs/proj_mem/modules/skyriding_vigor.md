...
- Style fill colors normalize RGBA components to 0–1 when a style layout is read or updated, so legacy or manually edited layout data cannot reach texture color APIs unchanged.
