...
- `sound_levels.custom_situations.<id>.name`, `.master`, `.sfx`, `.music`, `.ambience`, `.dialog`: user-created manual situations shown in the Situations list. They do not auto-trigger yet.
