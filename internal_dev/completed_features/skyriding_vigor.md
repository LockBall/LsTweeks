...
- `pwsh.exe -NoProfile -ExecutionPolicy Bypass -File internal_dev/tests_tools/check_fast.ps1` passed.

- `git diff --check` passed.

- `pwsh.exe -NoProfile -ExecutionPolicy Bypass -File internal_dev/tests_tools/lua_checks/kethos/run_luals_ketho.ps1` reported only the known Sound Levels `C_Sound.PlaySound(soundKitID, "SFX")` Ketho warnings.
