...
$testsTools = Join-Path $PSScriptRoot "tests_tools"
$projMem = Join-Path $PSScriptRoot "working_docs\proj_mem"
...
& (Join-Path $testsTools "doc_section.ps1") (Join-Path $projMem "project.md") "Active Compatibility Sentinel"

Write-Output "===== WoW API reference status ====="
& (Join-Path $testsTools "sync_wow_api_reference.ps1") -Channel live -StatusOnly -CompactStatus
...
& (Join-Path $testsTools "doc_section.ps1") (Join-Path $projMem "code_map.md") "Read-In Shortcuts"
