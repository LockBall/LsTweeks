...
- Architecture split: `modules/player_frame.lua` now owns settings/GUI/portrait text/event routing; `modules/player_frame/pf_fade.lua` owns the difficult OOC fade runtime and health curve gate. Keep future fade experiments in `pf_fade.lua`.
