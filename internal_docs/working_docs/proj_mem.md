...
modules/
  ...
  skyriding_vigor/       restored Skyriding Vigor display using Blizzard atlas assets and spell charges
    ...
    sv_styles.lua        Skyriding Vigor style/decor catalogs, setting specs, style DB helpers, and style-facing settings APIs
    sv_bar.lua           Skyriding Vigor bar visuals, Blizzard atlas slots, atlas sizing, wing layout, positioning, and slot rendering
