...
- Above `health_visible_threshold`, visibility uses an eased release toward the current fade alpha instead of snapping.
...
- `health_release_speed` adjusts only the curve weights above the threshold; it does not inspect health in addon Lua.
